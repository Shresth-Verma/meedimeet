...
export default function Home() {
  // Add console.log here to observe render behavior
        ...
        <div className="container mx-8 px-0">
          <div  className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">Connect with Doctor 
                <br></br> <span className="gradient-title">anytime,anywhere</span></h1>
